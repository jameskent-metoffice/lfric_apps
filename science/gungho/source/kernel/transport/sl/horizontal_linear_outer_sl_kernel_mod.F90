...
!!          linear semi-Lagrangian transport.
...
module horizontal_linear_outer_sl_kernel_mod
  ...
  type, public, extends(kernel_type) :: horizontal_linear_outer_sl_kernel_type
    private
  ...
  contains
    procedure, nopass :: horizontal_linear_outer_sl_code
  end type

  !-----------------------------------------------------------------------------
  ! Contained functions/subroutines
  !-----------------------------------------------------------------------------
  public :: horizontal_linear_outer_sl_code
  public :: horizontal_linear_outer_sl_1d
...
contains
  ...
  subroutine horizontal_linear_outer_sl_code( nlayers,         &
                                              increment_x,     &
                                              increment_y,     &
                                              field_x,         &
                                              stencil_sizes_x, &
  ...
  end subroutine horizontal_linear_outer_sl_code
...
! ============================================================================ !
  ...
  subroutine horizontal_linear_outer_sl_1d( nlayers,          &
                                            x_direction,      &
                                            increment,        &
                                            field,            &
                                            stencil_extent_l, &
  ...
  end subroutine horizontal_linear_outer_sl_1d

end module horizontal_linear_outer_sl_kernel_mod
