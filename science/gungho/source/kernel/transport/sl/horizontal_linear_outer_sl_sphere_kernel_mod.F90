...
module horizontal_linear_outer_sl_sphere_kernel_mod
  ...
  type, public, extends(kernel_type) :: horizontal_linear_outer_sl_sphere_kernel_type
    private
  ...
  contains
    procedure, nopass :: horizontal_linear_outer_sl_sphere_code
  end type

  !-----------------------------------------------------------------------------
  ! Contained functions/subroutines
  !-----------------------------------------------------------------------------
  public :: horizontal_linear_outer_sl_sphere_code
...
contains
  ...
  subroutine horizontal_linear_outer_sl_sphere_code( nlayers,           &
                                              increment_x,       &
                                              increment_y,       &
                                              field_x,           &
                                              stencil_sizes_x,   &
    ...
    use horizontal_linear_outer_sl_kernel_mod, only: horizontal_linear_outer_sl_1d
    ...
    if (use_spherical_treatment) then
      call horizontal_linear_outer_sl_sphere_1d( nlayers,           &
                                                 .true.,            &
                                                 increment_x,       &
                                                 field_y,           &
                                                 field_x,           &
      ...
      call horizontal_linear_outer_sl_1d( nlayers,           &
                                          .true.,            &
                                          increment_x,       &
                                          field_y,           &
                                          stencil_extent_xl, &
  ...
  end subroutine horizontal_linear_outer_sl_sphere_code
...
! ============================================================================ !
  ...
  subroutine horizontal_linear_outer_sl_sphere_1d( nlayers,           &
                                                   x_direction,       &
                                                   increment,         &
                                                   field,             &
                                                   field_swapped,     &
  ...
  end subroutine horizontal_linear_outer_sl_sphere_1d

end module horizontal_linear_outer_sl_sphere_kernel_mod
